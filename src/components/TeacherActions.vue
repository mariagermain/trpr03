...
const emit = defineEmits(['add-student', 'delete-student', 'see-questions'])
...
<template>
    <div class="container border border-dark border-1 rounded w-60">
        <span class="col w-100">
            ...
            <button type="button" class="btn btn-primary m-3 mx-auto w-100" id="delete-student" @click="deleteStudent()">Ajouter un étudiant de la classe</button>
